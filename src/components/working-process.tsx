    ...
    <Accordion type="single" collapsible className="space-y-8">
      {[
        ...
        <AccordionItem
          value={step.title}
          key={step.title}
          className="border-b-0 bg-stone-100 rounded-4xl md:rounded-[45px] drop-shadow-[0px_5px] drop-shadow-stone-700 data-[state=open]:bg-(--tertiary)! p-6 md:py-8 md:px-12 hover:bg-stone-200 divide-y divide-transparent data-[state=open]:divide-stone-950 duration-300"
        >
